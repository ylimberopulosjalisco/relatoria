...
# ==========================================================
# RELATORÍA COINVIERTE — PROPUESTA 4 + PREGUNTA SIMPLE
# ==========================================================
...
PREGUNTAS_POR_MESA = {
    "Estrategia, gobernanza y capacidades": [
        ...
        "Seguimiento. ¿Esto que estamos escuchando es algo particular de su empresa, o creen que es común en su sector?",
        "Seguimiento. ¿Esto cambia mucho entre una empresa grande y una pyme?",
        "Seguimiento. ¿Tienen un ejemplo concreto que nos ayude a entender mejor el problema?",
        "Seguimiento. ¿Qué actor podría habilitar o destrabar esta situación?",
        "Seguimiento. ¿Qué faltó o qué no deberíamos perder antes de cerrar esta ronda?",
    ],
    "Operación circular, recursos y cadenas de valor": [
...
with tab_captura:
    ...
    pregunta_referencia = st.selectbox(
        ...
        PREGUNTAS_POR_MESA[mesa],
        help="La lista cambia automáticamente según la mesa seleccionada."
    )
    st.caption(
    ...
    # Estos dos selectores van fuera del formulario para que Streamlit
    # pueda reaccionar inmediatamente al elegir Otra/Otro.
    pre1, pre2 = st.columns(2)
    with pre1:
        barrera = st.selectbox(
            "Barrera principal",
            BARRERAS,
            key="barrera_principal_live"
        )
...
with tab_hallazgos:
    ...
    if filtro_mesa != "Todas":
        preguntas_filtro = PREGUNTAS_POR_MESA[filtro_mesa]
